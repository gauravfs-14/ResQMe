            ...
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="overview" className="space-y-4">
                <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Details about the emergency situation</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-sm font-medium mb-1">AI Generated Message</h4>
                        <p className="text-sm p-3 bg-muted/50 rounded-md">{alert.aiGeneratedMessage}</p>
                      </div>
                      <div>
                        <h4 className="text-sm font-medium mb-1">Severity Assessment</h4>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                            ...
                            <p className="text-sm font-medium">{alert.severityAssessment.severityLevel}</p>
                          </div>
                          <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                            <p className="text-xs text-muted-foreground">Confidence Score</p>
                            <p className="text-sm font-medium">{alert.severityAssessment.confidenceScore}</p>
                          </div>
                        </div>
                      </div>
                      {alert.severityAssessment.triageNotes && (
                        <div>
                          <h4 className="text-sm font-medium mb-1">Triage Notes</h4>
                          <p className="text-sm p-3 bg-muted/50 rounded-md">{alert.severityAssessment.triageNotes}</p>
                        </div>
                      )}
                    </div>
                  </CardContent>
                ...
                <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Current status and response information</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-2">
                        <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                          ...
                          <p className="text-sm font-medium">{alert.responderStatus.currentStatus}</p>
                        </div>
                        <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                          <p className="text-xs text-muted-foreground">Last Updated</p>
                          <p className="text-sm font-medium">{formatTime(alert.responderStatus.lastUpdated)}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        {alert.responderStatus.currentStatus === "In Progress" && (
                          <Dialog open={isResolutionDialogOpen} onOpenChange={setIsResolutionDialogOpen}>
                            ...
                            <DialogContent>
                              ...
                              <DialogFooter>
                                ...
                                <Button onClick={handleResolutionSubmit}>Resolve Alert</Button>
                              </DialogFooter>
                            </DialogContent>
                          </Dialog>
                        )}
              ...
              <TabsContent value="profile" className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">User ID: {alert.userId}</p>
                        </div>
                      </div>

                      {alert.profileSummary.medicalConditions && alert.profileSummary.medicalConditions.length > 0 && (
                        <div>
                          <h4 className="text-sm font-medium mb-1">Medical Conditions</h4>
                          <div className="flex flex-wrap gap-1">
                            {alert.profileSummary.medicalConditions.map((condition, index) => (
                      ...
                      {alert.profileSummary.allergies && alert.profileSummary.allergies.length > 0 && (
                        <div>
                          <h4 className="text-sm font-medium mb-1">Allergies</h4>
                          <div className="flex flex-wrap gap-1">
                            {alert.profileSummary.allergies.map((allergy, index) => (
                              <Badge key={index} variant="outline" className="bg-orange-50 dark:bg-orange-900/20">
                                {allergy}
                              </Badge>
                            ))}
                          </div>
                      ...
                      {alert.profileSummary.currentMedications &&
                        alert.profileSummary.currentMedications.length > 0 && (
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {alert.profileSummary.currentMedications.map((medication, index) => (
                      ...
                      {alert.profileSummary.additionalNotes && (
                        <div>
                          ...
                          <p className="text-sm p-3 bg-muted/50 rounded-md">{alert.profileSummary.additionalNotes}</p>
                        </div>
                      )}
                    </div>
                  </CardContent>
                ...
                <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
                  ...
                  <CardContent>
                    {alert.profileSummary.emergencyContacts && alert.profileSummary.emergencyContacts.length > 0 ? (
                      <div className="space-y-3">
                        {alert.profileSummary.emergencyContacts.map((contact, index) => (
                          <div
                            key={index}
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-2">
                          <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                            ...
                            <p className="text-sm font-medium">{alert.location.latitude}</p>
                          </div>
                          <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                            <p className="text-xs text-muted-foreground">Longitude</p>
                            <p className="text-sm font-medium">{alert.location.longitude}</p>
                          </div>
                        </div>
                        <div className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200">
                          <p className="text-xs text-muted-foreground">Accuracy</p>
                          <p className="text-sm font-medium">{alert.location.accuracy}</p>
                        </div>
              ...
              <TabsContent value="nearby" className="space-y-4">
                <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Hospitals, police stations, and fire stations</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Tabs defaultValue="hospitals">
                      ...
                      <TabsContent value="hospitals">
                        ...
                        alert.serpApiContext.nearbyFacilities.hospitals.length > 0 ? (
                          <div className="space-y-3">
                            {alert.serpApiContext.nearbyFacilities.hospitals.map((hospital, index) => (
                              <div
                                key={index}
                              ...
                              >
                                <div className="flex justify-between">
                                  ...
                                  <Badge variant="outline">{hospital.distanceMiles} mi</Badge>
                                </div>
                                ...
                                <div className="mt-2 flex justify-between">
                                  ...
                                  <Button
                                    variant="outline"
                                    size="sm"
                                    onClick={() => window.open(hospital.mapsLink, "_blank")}
                                  >
                                    <MapPin className="mr-2 h-4 w-4" />
                                    Directions
                                  </Button>
                          ...
                          <div className="flex items-center justify-center h-40">
                            <p className="text-muted-foreground">No nearby hospitals found</p>
                          </div>
                        )}
                      </TabsContent>
                      ...
                      <TabsContent value="police">
                        ...
                        alert.serpApiContext.nearbyFacilities.policeStations.length > 0 ? (
                          <div className="space-y-3">
                            {alert.serpApiContext.nearbyFacilities.policeStations.map((station, index) => (
                              <div
                                key={index}
                                className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200"
                              >
                                <div className="flex justify-between">
                                  ...
                                  <Badge variant="outline">{station.distanceMiles} mi</Badge>
                                </div>
                                ...
                                <div className="mt-2 flex justify-between">
                                  ...
                                  <Button
                                    variant="outline"
                                    size="sm"
                                    onClick={() => window.open(station.mapsLink, "_blank")}
                                  >
                                    <MapPin className="mr-2 h-4 w-4" />
                                    Directions
                                  </Button>
                          ...
                          <div className="flex items-center justify-center h-40">
                            <p className="text-muted-foreground">No nearby police stations found</p>
                          </div>
                        )}
                      </TabsContent>
                      ...
                      <TabsContent value="fire">
                        ...
                        alert.serpApiContext.nearbyFacilities.fireStations.length > 0 ? (
                          <div className="space-y-3">
                            {alert.serpApiContext.nearbyFacilities.fireStations.map((station, index) => (
                              <div
                                key={index}
                                className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200"
                              >
                          ...
                          <div className="flex items-center justify-center h-40">
                            <p className="text-muted-foreground">No nearby fire stations found</p>
                          </div>
                        )}
                      </TabsContent>
                    </Tabs>
                ...
                <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Current weather at the location</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {alert.serpApiContext?.weather && alert.serpApiContext.weather.length > 0 ? (
                      <div className="space-y-3">
                        {alert.serpApiContext.weather.map((weather, index) => (
                          <div
                            ...
                            className="rounded-md border p-3 hover:bg-muted/30 transition-colors duration-200"
                          >
                            <h4 className="font-medium">{weather.condition || "Current Weather"}</h4>
                            <div className="grid grid-cols-2 gap-2 mt-2">
                              {weather.temperature && (
                                <div className="rounded-md border p-2">
                                  <p className="text-xs text-muted-foreground">Temperature</p>
                                  <p className="text-sm font-medium">{weather.temperature}</p>
                                </div>
                              )}
                              {weather.humidity && (
                                <div className="rounded-md border p-2">
                              ...
                              {weather.visibility && (
                                <div className="rounded-md border p-2">
                                  ...
                                  <p className="text-sm font-medium">{weather.visibility}</p>
                                </div>
                              )}
                            </div>
                          </div>
                      ...
                      <div className="flex items-center justify-center h-40">
                        <p className="text-muted-foreground">No weather information available</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
                  ...
                  <div className="space-y-6">
                    <div className="relative">
                      ...
                      <div>
                        ...
                        <p className="text-sm mt-1">{alert.aiGeneratedMessage}</p>
                      </div>
                    </div>
                    ...
                    {alert.responderStatus.currentStatus !== "Pending" && (
                      <div className="relative">
                        ...
                        <div>
                          ...
                          <p className="text-sm mt-1">Alert status changed to In Progress</p>
                        </div>
                      </div>
                    )}
                    ...
                    {alert.responderStatus.currentStatus === "Resolved" && (
                      <div className="relative">
                        ...
                        <div>
                          ...
                          <p className="text-sm mt-1">Emergency situation has been resolved</p>
                        </div>
                      </div>
                    )}
                  </div>
