...
export default function ProfileForm({ userId, user }: ProfileFormProps) {
  ...
  const [formState, setFormState] = useState({
    ...
    emergencyContacts: [{ name: "", relation: "", phone: "", email: "", priority: 1 }],
  ...
  const addField = (field: string) => {
    switch (field) {
      ...
      case "allergies":
        ...
        break
      case "medications":
        updateForm("currentMedications", [...formState.currentMedications, { name: "", purpose: "", dosage: "" }])
        break
      case "contacts":
        updateForm("emergencyContacts", [
          ...formState.emergencyContacts,
          { name: "", relation: "", phone: "", email: "", priority: formState.emergencyContacts.length + 1 },
        ])
        break
    }
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <TabsContent value="personal">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide your basic personal information for emergency services.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(value) => updateForm("gender", value)} value={formState.gender}>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) => updateForm("primaryLanguage", value)}
        ...
        <TabsContent value="medical">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide your medical information to help emergency responders.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Medical Conditions */}
              ...
              <div className="space-y-4">
                ...
                {formState.currentMedications.map((medication, index) => (
                  <div key={`medication-${index}`} className="space-y-4 p-4 border rounded-md">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {formState.emergencyContacts.map((contact, index) => (
                <div key={`contact-${index}`} className="space-y-4 p-4 border rounded-md">
                  <div className="flex justify-between items-center">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor={`contact-email-${index}`}>Email (Optional)</Label>
                      <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`contact-priority-${index}`}>Priority (1 = highest)</Label>
                    <Select
        ...
        <TabsContent value="preferences">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set your communication preferences and device information.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      const newPrefs = { ...formState.communicationPreferences, preferredMethod: value }
                ...
                <div className="space-y-2">
                  <Label htmlFor="backupMethod">Backup Communication Method</Label>
                  <Select
                    value={formState.communicationPreferences.backupMethod}
                    onValueChange={(value) => {
                      const newPrefs = { ...formState.communicationPreferences, backupMethod: value }
                      updateForm("communicationPreferences", newPrefs)
                    }}
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      const newDeviceInfo = { ...formState.deviceInfo, deviceType: value }
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      const newDeviceInfo = { ...formState.deviceInfo, usesLoopMessage: checked === true }
                      updateForm("deviceInfo", newDeviceInfo)
                    }}
                  />
                  <Label
              ...
              <div className="space-y-4 pt-4 border-t">
                <div className="flex flex-col space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground ml-6">
                    I consent to location tracking for emergency services. This information will only be used in case of
                    an emergency.
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between pt-4">
                <Button type="button" variant="outline" onClick={() => setActiveTab("emergency")}>
      ...
      <div className="flex justify-end space-x-4">
        ...
        <Button type="submit" className="bg-[#00437c] hover:bg-[#003366]" disabled={isSubmitting}>
          {isSubmitting ? (
